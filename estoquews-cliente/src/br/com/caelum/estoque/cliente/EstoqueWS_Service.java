 ...
 * 
 */
@WebServiceClient(name = "EstoqueWS", targetNamespace = "http://ws.estoque.caelum.com.br/", wsdlLocation = "http://localhost:8080/estoquews-web-1.0-SNAPSHOT/EstoqueWS?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/estoquews-web-1.0-SNAPSHOT/EstoqueWS?wsdl");
